...
1. Select _People_ &rarr; _Teams_. <!-- A screenshot here is more useful to help someone know where in the nav they should be at a glance. -->

    > **Note:** You can configure other Site membership groupings, such as _Users_, _Organizations_, and _User Groups_ in the _Site Memberships_ app, which is also in the _Members_ tab. You can visit [User Management](TODO) for more information on how Site memberships work.
