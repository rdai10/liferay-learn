...
1. On the _Pages_ page, click the _Add_ button (![Add](../../../images/icon-add.png)), and then click _Add Page_.
...
1. Configure the remaining settings for the page, and then click _Add_ to create the page.
...
1. Click ( ![Page Tree icon](../../../images/icon-page-tree.png) ) _Page Tree_ in the Site Menu on the left side of the screen.

1. Select _Add Child Page_ from the Actions Menu ( ![Actions icon](../../../images/icon-actions.png) ) next to an existing page to create a nested child page for it.
